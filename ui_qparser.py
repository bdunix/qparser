...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.parsePushButton.setGeometry(QtCore.QRect(40, 500, 75, 23))
        self.parsePushButton.setObjectName("parsePushButton")
        self.exitPushButton = QtWidgets.QPushButton(self.centralwidget)
        self.exitPushButton.setGeometry(QtCore.QRect(130, 500, 75, 23))
        self.exitPushButton.setObjectName("exitPushButton")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(40, 250, 541, 212))
